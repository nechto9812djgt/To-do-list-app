# To-do-list-app
Task: Create an app on based vueschool.io's course vuejs-3-fundamentals.<br>
...
To start you need to click "Show list", also you can hide it by clicking "Cancel"<br>
# index.html
```
<!DOCTYPE html>
<html lang="en">
